...
public class RoguePassengerRequest {
    ...
    public RoguePassengerRequest() {

    }

    public RoguePassengerRequest(String name, String contact, String nic, String passport, double loanAmount) {
        this.name = name;
