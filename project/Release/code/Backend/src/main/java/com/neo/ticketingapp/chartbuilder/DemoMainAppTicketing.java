...
public class DemoMainAppTicketing {

	public static void main(String[] args) {
		
		ChartBuilder cb = new ChartBuilder() ; 
		
//		Chart day = cb.buildChart_DistributionOverADay(); 
//		day.showDetails();
//		
//		Chart week = cb.buildChart_DistributionOverAWeek();
//		week.showDetails();
		
//		List<PassengerJourneyLog> passengerJouneyLogs ; 
//		PassengerJourneysLogServiceImpl j = new PassengerJourneysLogServiceImpl(); 
//		
//		passengerJouneyLogs = j.getLogsByRoute(177); 
//		PassengerJourneyLog j1 = passengerJouneyLogs.get(0);
//		
//		System.out.println(j1.getStartStation());
	}
}
