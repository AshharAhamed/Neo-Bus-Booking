...
export default class ChartService {
    ...
    getPassengerDistributionOverADay() {
        return new Promise((resolve, reject) => {
            this.apiService.getLocal("chart/passengerDistributionOverDay").then(response => {
                resolve(response);
            }).catch(error => {
                reject(error);
            })
    ...
    getPassengerDistributionOverAWeek() {
        return new Promise((resolve, reject) => {
            this.apiService.getLocal("chart/passengerDistributionOverWeek").then(response => {
                resolve(response);
            }).catch(error => {
                reject(error);
            })
    ...
    getFinanceDistributionOverTheYear() {
        return new Promise((resolve, reject) => {
            this.apiService.getLocal("chart/financeOverYear").then(response => {
                resolve(response);
            }).catch(error => {
                reject(error);
            })
    ...
    getFinanceGrowth() {
        return new Promise((resolve, reject) => {
            this.apiService.getLocal("chart/financeGrowthYearly").then(response => {
                resolve(response);
            }).catch(error => {
                reject(error);
            })
    ...
    getFinesDistributionOverTheYear() {
        return new Promise((resolve, reject) => {
            this.apiService.getLocal("chart/finesOverYear").then(response => {
                resolve(response);
            }).catch(error => {
                reject(error);
            })
    ...
    getFraudGrowth() {
        return new Promise((resolve, reject) => {
            this.apiService.getLocal("chart/fraudsGrowthYearly").then(response => {
                resolve(response);
            }).catch(error => {
                reject(error);
            })
    ...
    getAllFinanceByRoute() {
        return new Promise((resolve, reject) => {
            this.apiService.getLocal("chart/allFinanceTable").then(response => {
                resolve(response);
            }).catch(error => {
                reject(error);
            })
    ...
    getAllFinesByRoute() {
        return new Promise((resolve, reject) => {
            this.apiService.getLocal("chart/allFinesTable").then(response => {
                resolve(response);
            }).catch(error => {
                reject(error);
            })
